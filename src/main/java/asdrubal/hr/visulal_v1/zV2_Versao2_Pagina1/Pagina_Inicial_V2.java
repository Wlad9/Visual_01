...
public class Pagina_Inicial_V2 extends JFrame {
    ...
    private String txt1_BtPareos = "Seleciona um dos páreos";
    private String txt2_BtPareos = "Mostrar lista de páreos";

    public Pagina_Inicial_V2(Map<Integer, ProgramaDTO> openPrograms, PareoService pareoService, CompetidorService competidorService, TempService tempService, IndicesService indicesService, CavaloService cavaloService, RaiaService raiaService, RegistroService registroService, AnaliseService analiseService) {
